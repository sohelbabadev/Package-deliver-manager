...
function Card({
    ...
    return (
        <div className='w-full h-[450px] md:h-[180px] p-3 rounded-md bg-blue-50  border-1 border-blue-300'>
            <div className='w-full h-full flex flex-col md:flex-row gap-2 items-start'>
                <div className='w-full md:w-1/3 p-4 h-full flex flex-col gap-1'>
                ...
                <div className='w-full md:w-1/3 h-full flex flex-col md:p-4 p-2'>
                    <div className='w-full flex flex-row md:gap-2 md:items-end md:justify-end'>
                        <Typography fontWeight={'bold'} className='uppercase font-bold md:text-1xl'>Current Location : </Typography>
                        <Typography className='capitalize'>{data.currentLocation}</Typography>
                    </div>
                    <div className='w-full flex flex-row md:gap-2 justify-end'>
                        <Typography fontWeight={'bold'} className='font-bold md:text-1xl'>Created Date : </Typography>
                        <Typography>{formatDate()}</Typography>
                    </div>
                </div>
                <div className='w-full md:w-1/3 h-full p-4 flex flex-col md:justify-start md:items-end gap-2'>
                    <button
